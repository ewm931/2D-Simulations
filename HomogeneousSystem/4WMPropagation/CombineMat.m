...
%Pop_X0 = dlmread(strcat(Folder,'Pop_X0.dat'),'\t');
%Pop_X1 = dlmread(strcat(Folder,'Pop_X1.dat'),'\t');
%Pop_X2 = dlmread(strcat(Folder,'Pop_X2.dat'),'\t');
%Pop_X3 = dlmread(strcat(Folder,'Pop_X3.dat'),'\t');
%delete(strcat(Folder,'Pop_X*.dat'));
